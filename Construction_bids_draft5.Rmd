...
blend = 0.2 # pick penalization process (between 0 and 1)
train2 = train[,-c(1:5,7:10,12,14,53,58)] 
  train2 = na.omit(train2) 
test2 = test[,-c(1:5,7:10,12,14,53,58)] 
  test2 = na.omit(test2) 
  x = train2[,-5]
  x = data.matrix(x) 
```
...
cv.predict 
length(cv.predict)
write.csv(cv.predict, "Predictions_CV.csv") 
```
