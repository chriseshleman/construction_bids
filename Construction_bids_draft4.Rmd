...
final = lm(log(bids$Second.Bid) ~ bids$Engr.Est + bids$quantile_2 + bids$quantile_3 + bids$quantile_4 + bids$quantile_5 + bids$Format2)
final2 = lm(log(bids$Second.Bid) ~ bids$Engr.Est + bids$quantile_5 + bids$Format2) 
```
...
write.csv( tidy(final2) , "./coefs2.csv" )
write.csv( glance(final2) , "./an2.csv" )
write.csv(final2$fitted.values,"./Predictions2 20191120.csv") 
```
